...
<section class="banner">
    ...
    <div class="banner__video">
        <a href="../../../watch.html?v=XHOmBV4js_E" class="popup-video"><i class="fas fa-play"></i></a>
    </div>
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    ...
                    <div class="services__content">
                        ...
                        <a href="{{route('portfolio')}}" class="btn border-btn">Read more</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="homeContact__content">
                        ...
                        <h2 class="mail"><a href="/cdn-cgi/l/email-protection#6c25020a032c1b090e010d0500420f0301"><span class="__cf_email__" data-cfemail="a1e8cfc7cee1d6c4c3ccc0c8cd8fc2cecc">[email&#160;protected]</span></a></h2>
                    </div>
                </div>
                <div class="col-lg-6">
